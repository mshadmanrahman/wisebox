    ...
    <div className="px-6 py-8 space-y-8">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-wisebox-text-primary">{t('learning.title')}</h1>
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-wisebox-background-card border border-wisebox-border text-wisebox-text-primary text-sm placeholder:text-wisebox-text-muted focus:outline-none focus:border-wisebox-primary/50 transition-colors"
        />
      </div>
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            activeCategory === 'all'
              ...
              : 'bg-wisebox-background-card border border-wisebox-border text-wisebox-text-secondary hover:text-wisebox-text-primary hover:border-wisebox-border-light'
          }`}
        >
              ...
              >
                <Card className="bg-wisebox-background-card border-wisebox-border hover:border-wisebox-border-light transition-all hover:shadow-lg h-full overflow-hidden">
                  ...
                  <CardContent className="p-5 space-y-3">
                    <h3 className="text-base font-semibold text-wisebox-text-primary group-hover:text-wisebox-primary transition-colors line-clamp-2">
                      {article.title}
                    </h3>
      ...
      <Card className="bg-gradient-to-r from-wisebox-primary/20 via-wisebox-primary/10 to-wisebox-primary/5 border-wisebox-primary/30">
        <CardContent className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <h3 className="font-semibold text-wisebox-text-primary">
