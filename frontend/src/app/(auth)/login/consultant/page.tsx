    ...
    <div className="min-h-screen flex bg-wisebox-background">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-icon-accent rounded-lg flex items-center justify-center">
              <Briefcase className="w-5 h-5 text-wisebox-text-primary" />
            </div>
            <span className="text-xl font-semibold text-wisebox-text-primary">{t('login.brand')}</span>
          </div>

          {/* Header */}
          <div>
            <h1 className="text-3xl font-bold text-wisebox-text-primary mb-2">{t('login.title')}</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full bg-wisebox-accent-emerald hover:bg-wisebox-accent-emerald/90 text-wisebox-text-primary h-12 font-semibold"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
            ...
            <p className="text-center text-sm text-wisebox-text-muted">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-auth-consultant p-12 items-center justify-center">
        <div className="max-w-md text-wisebox-text-primary space-y-8">
          <Briefcase className="w-16 h-16 text-wisebox-text-primary/80" />
          <h2 className="text-3xl font-bold">{t('login.sideTitle')}</h2>
          <div className="space-y-4 text-wisebox-text-primary/90">
