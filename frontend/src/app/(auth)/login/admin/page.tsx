    ...
    <div className="min-h-screen flex bg-wisebox-background">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-icon-secondary rounded-lg flex items-center justify-center">
              <Shield className="w-5 h-5 text-wisebox-text-primary" />
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full bg-wisebox-secondary hover:bg-wisebox-secondary/90 text-wisebox-text-primary h-12 font-semibold"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-auth-admin p-12 items-center justify-center">
        <div className="max-w-md text-wisebox-text-primary space-y-8">
          <Shield className="w-16 h-16 text-wisebox-text-primary/80" />
