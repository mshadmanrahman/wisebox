...
export function DashboardHeroBanner({ className }: DashboardHeroBannerProps) {
  return (
    <div className={cn("relative overflow-hidden rounded-2xl bg-foreground dark:bg-card p-8 sm:p-10", className)}>
      ...
      <div className="absolute bottom-0 left-1/3 w-48 h-48 bg-primary/10 rounded-full blur-3xl translate-y-1/2" />
      ...
      <div className="relative z-10">
        ...
        <div className="mt-5 flex gap-3">
          <a href="/services" className="bg-white text-foreground rounded-full px-5 py-2.5 text-sm font-medium hover:bg-white/90 transition-all">Learn More</a>
          <a href="/assessment/start" className="border border-white/30 text-white rounded-full px-5 py-2.5 text-sm font-medium hover:bg-white/10 transition-all dark:border-border dark:text-foreground dark:hover:bg-muted">Get Free Assessment</a>
        </div>
      </div>
    </div>
  )
