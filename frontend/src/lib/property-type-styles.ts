...
const PALETTES = [
  { a: 'rgba(235,150,140,0.12)', b: 'rgba(180,150,210,0.08)', c: 'rgba(220,180,160,0.06)' },
  { a: 'rgba(100,160,230,0.12)', b: 'rgba(80,200,190,0.08)',  c: 'rgba(140,180,220,0.06)' },
  { a: 'rgba(220,180,100,0.12)', b: 'rgba(210,140,150,0.08)', c: 'rgba(230,200,140,0.06)' },
  { a: 'rgba(80,200,140,0.12)',  b: 'rgba(140,220,180,0.08)', c: 'rgba(100,210,160,0.06)' },
  { a: 'rgba(170,130,210,0.12)', b: 'rgba(210,150,180,0.08)', c: 'rgba(180,140,200,0.06)' },
  { a: 'rgba(240,170,120,0.12)', b: 'rgba(240,210,130,0.08)', c: 'rgba(230,180,140,0.06)' },
  { a: 'rgba(130,160,230,0.12)', b: 'rgba(160,140,220,0.08)', c: 'rgba(140,170,210,0.06)' },
  { a: 'rgba(160,190,130,0.12)', b: 'rgba(180,160,120,0.08)', c: 'rgba(150,180,140,0.06)' },
];
