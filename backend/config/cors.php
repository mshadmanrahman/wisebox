...
return [
    ...
    'allowed_origins' => array_values(array_unique(array_filter(array_map(
        'trim',
        array_merge(
            explode(',', env('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,https://wisebox-v2.vercel.app,https://wisebox-fork.vercel.app,https://app.mywisebox.com,https://mywisebox.com')),
